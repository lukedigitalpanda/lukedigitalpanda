    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center py-16">
          ...
          <h3 className="font-semibold text-gray-700">No documents available</h3>
          <p className="mt-1 text-sm text-gray-500 text-center max-w-sm">
            Shared documents such as policies, procedures and guides will appear here once uploaded by your IT provider.
          </p>
        </CardContent>
      </Card>
    </div>
