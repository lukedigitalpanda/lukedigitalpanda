...
import { ArrowLeft, Ticket, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function MyTicketsPage() {
  ...
  useEffect(() => {
    ...
    fetchTickets();
  }, [isLoggedIn, contact, client, page, statusFilter]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">My Issues & Requests</h1>
        <Select value={statusFilter} onValueChange={(v) => { setStatusFilter(v); setPage(1); }}>
          ...
          <SelectContent>
            ...
            <SelectItem value="WAITING_ON_CLIENT">Waiting on Me</SelectItem>
        ...
        <Card>
          <CardContent className="flex flex-col items-center py-16">
            ...
            <Link href="/portal/submit">
              <Button className="mt-4" size="sm">Report an Issue</Button>
            </Link>
          </CardContent>
        </Card>
      ) : (
