...
async function main() {
  ...
  const clients = await Promise.all([
    ...
    prisma.client.create({ data: { name: "Tailspin Toys", email: "it@tailspintoys.co.uk", phone: "0117 345 6789", address: "Bristol Retail Park, BS1 3XD", contractType: "Project", slaLevel: "Silver", notes: "Ongoing migration project" } }),
  ]);
